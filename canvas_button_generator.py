...
str2 = " target=\"_"
str21 = "\" data-api-endpoint=\"https://cvilleschools.instructure.com/api/v1/courses/"
...
#phys
#links = ["https://cvilleschools.instructure.com/courses/" + course + "/modules",
#         "https://charlottesvilleschools.zoom.us/j/81459666176",
#         "https://charlottesvilleschools.zoom.us/my/drshields"]
#capstone
links = ["https://cvilleschools.instructure.com/courses/" + course + "/modules",
         "https://charlottesvilleschools.zoom.us/j/88921166863",
         "https://charlottesvilleschools.zoom.us/my/drshields"]
#eng4
#links = ["https://cvilleschools.instructure.com/courses/" + course + "/modules",
#         "https://charlottesvilleschools.zoom.us/j/83482605350",
#         "https://charlottesvilleschools.zoom.us/j/86184753524",
#         "https://charlottesvilleschools.zoom.us/my/drshields"]
...
#eng 3, phys, capstone
target = ["self", "blank", "blank"]
#eng 4
#txt = ["self", "blank", "blank", "blank"]
...
for i, link in enumerate(links):
    out = str1 + link + str2 + target[i] + str21 + course + str25 + txt[i] + str26 + course + str3 + imgs[i] + str4 + course + str5
    print(out)
